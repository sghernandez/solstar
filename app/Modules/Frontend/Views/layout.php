...
<html lang="es">
  <head>
    ...
    <link href="<?= base_url('assets/css/jquery-ui-1.8.21.custom.css') ?>" rel="stylesheet">            
    <!-- CSS personalizado -->
  ...
  <body>
    <nav class="navbar navbar-default">
      <div class="container-fluid">
        <div class="navbar-header">
            <a class="navbar-brand" href="#"><a href="<?= base_url() ?>"><img height="44" title="CodeIgniter Logo"
        ...
        <ul class="nav navbar-nav">
          <li><a href="<?= base_url('cantantes') ?>">Cantantes</a></li>
         <!-- <li><a href="javascript:void(0)" onclick="ruta('test?q=Productos')">Productos</a></li>
          <li><a href="javascript:void(0)" onclick="ruta('test?q=Servicios')">Servicios</a></li>
          <li><a href="javascript:void(0)" onclick="ruta('test?q=Blog')">Blog</a></li>
    ...
    <div id="content" class="container">
        <?php if(isset($view)) { echo view($view); } ?>
    </div>
    ...
    <script src="<?= base_url('assets/js/plugins/jquery-2.2.4/jquery-2.2.4.min.js') ?>"></script>      
    <script src="<?= base_url('assets/js/plugins/jquery-ui-1.11.4/jquery-ui.min.js') ?>"></script>  
    <script src="https://cdn.jsdelivr.net/npm/axios/dist/axios.min.js"></script>
    
    <!-- Datatables -->
    <script src="<?= base_url('assets/js/plugins/DataTables-1.10.15/jquery.dataTables.min.js') ?>"></script> 
    <script src="<?= base_url('assets/js/plugins/DataTables-1.10.15/dataTables.bootstrap.min.js') ?>"></script>     
        
    <!-- JQuery Validation -->
    <script src="<?= base_url('assets/js/plugins/jqueryValidation-1.17.0/jquery.validate.min.js') ?>"></script>      

    <!-- Bootstrap -->
    <script src="<?= base_url('assets/js/bootstrap.min.js') ?>"></script>
    
    <!-- Funciones personalizadas -->
    <script src="<?= base_url('assets/js/functions_datatables.js') ?>"></script>
